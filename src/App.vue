<template>
  ...
  <ModalDialog id="creditsModal" :title="t('footer.credits')">
    <template #body>
      <h4><a href="https://boardgamegeek.com/boardgame/383179/age-of-innovation" target="_blank" rel="noopener">{{t('gameTitle')}}</a></h4>
      <dl>
        <dt>Game design</dt>
        <dd>Helge Ostertag</dd>
        <dt>Artist</dt>
        <dd>Álvaro Calvo Escudero, Lukas Siegmon</dd>
        <dt>Solo Mode Design</dt>
        <dd>Automa Factory: David Studley, Lines J. Hutter and Morten Monrad Pedersen with Mike Martins</dd>
        <dt>Publisher</dt>
      ...
      <dl>
        ...
        <dt>Version</dt>
        <dd>{{buildNumber}} (<a href="https://github.com/brdgm/age-of-innovation-solo-helper/releases" target="_blank" rel="noopener">Change Log</a>)</dd>
        <dt>Source Code (Apache-2.0 License)</dt>
        <dd><a href="https://github.com/brdgm/age-of-innovation-solo-helper" target="_blank" rel="noopener">https://github.com/brdgm/age-of-innovation-solo-helper</a></dd>
      </dl>
    </template>
  </ModalDialog>
